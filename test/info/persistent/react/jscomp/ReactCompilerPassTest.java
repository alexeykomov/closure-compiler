...
public class ReactCompilerPassTest {
  ...
  @Test
  public void testMinimalComponent() {
    test(
  ...
  @Test
  public void testMixinsRepeatedMethods() {
    test(
      "var Mixin = React.createMixin({" +
  ...
  @Test
  public void testNamespacedComponent() {
    test(
  ...
  @Test
  public void testUnusedComponent() {
    test(
   ...
   */
  @Test
  public void testCreateClassValidation() {
    testError(
   ...
   */
  @Test
  public void testCreateMixinValidation() {
    testError(
   ...
   */
  @Test
  public void testMixinsValidation() {
    testError(
   ...
   */
  @Test
  public void testCreateElementValidation() {
    testError(
        "React.createElement()",
   ...
   */
  @Test
  public void testCreateElementCasting() {
  ...
  @Test
  public void testNoRenameReactApi() {
  ...
  @Test
  public void testPropTypesTypeChecking() {
  ...
  @Test
  public void testReactDOMServer() {
    test("var Comp = React.createClass({});" +
  ...
  @Test
  public void testGetDefaultPropsThis() {
    test(
      "var Comp = React.createClass({" +
        "statics: {" +
          "CONST: 123" +
  ...
  @Test
  public void testPureRenderMixin() {
    test(
      "var Comp = React.createClass({" +
  ...
  @Test
  public void testElementTypedef() {
    test(
      "var Comp = React.createClass({" +
        "render: function() {" +
          "return React.createElement(\"div\");" +
